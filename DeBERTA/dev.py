from transformers import DataCollatorWithPadding,TrainingArguments,default_data_collator,EvalPrediction,DebertaForSequenceClassification,AutoTokenizer,Trainer
import pandas as pd
import os
import numpy as np
import torch
...
def compute_metrics(eval_pred):
    ...
    mAP_strict, mAP_relaxed = evaluate_predictions(predictions)
    acc=accuracy.compute(predictions=predictions, references=labels)
    return acc,mAP_strict, mAP_relaxed
